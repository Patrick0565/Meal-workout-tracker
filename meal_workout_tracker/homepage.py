...
class HomePageWidget(QWidget):
    def __init__(self):
        ...
        instruction_label2 = QLabel("Select other options from the drop-down menu to navigate to different sections of the app.")
        instruction_label3 = QLabel("- Select 'Workout info' from the drop-down menu to edit workout information.")
